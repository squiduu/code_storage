                ...
                if bstate[domain]["book"][slot] != "":
                    ...
                    summary_bvalue.append(
                        [
                            ...
                            normalize(bstate[domain]["book"][slot].strip().lower(), False),
                        ]
...
def createData(args):
    ...
    for didx, dialogue_name in tqdm(enumerate(data), desc="Creating data", total=len(data)):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--main_dir", type=str, default="data_mwoz_2.1")
